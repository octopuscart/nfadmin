                ...
                <div class="table-responsive" id="featureProduct">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $count = 1;
                            if ($all_popular_product) { 
                                foreach ($all_popular_product as $key => $value) {
                                    echo '<tr>';
                                    echo '<td><div class="checkbox"><label><input name="offer_product[]" type="checkbox" value="' . $value['id'] . '"></label></div></td>';
                                    echo '<td>' . $count . '</td>';
                                    echo '<td>' . $value['title'] . '</td>';
                                    echo '<td>' . $value['sku'] . '</td>';
                                    echo '<td><img src='.image_server.'nfw/smaller/'.  $value['image'] . ' style="height:45px;width:60px;"/></td>';
