...
<p style="text-align: center;"><span style="font-size: 24px; font-weight: bold;">YOUR ORDER HAS SHIPPED</span></p>
<p style="text-align: center;"><span style="font-size: 24px; line-height: 28.799999237060547px;"><br></span></p>
<div style="text-align: left; line-height: 1;"><span style="font-size: 18px;">Hello  &nbsp;'. ucwords($user_info[0]['first_name'].' '.$user_info[0]['last_name']).',</span></div>
<div style="text-align: left; line-height: 1.5;"><span style="line-height: 1.4;"><br></span></div>
<div style="text-align: left;"><span style="line-height: 19.600000381469727px;">We are pleased to inform you that your order  &nbsp;'.$orderNo[0]['order_no']. '&nbsp; has shipped.</span></div>
...
<p style="text-align: center; line-height: 1.5;"><span style="font-size: 24px; font-weight: bold; line-height: 28.799999237060547px;"><br></span></p>';
    ...
    $mail->Subject = 'Order'.' '.$orderNo[0]['order_no'].'  Shipping Confirmation!'; //Subject od your mail
