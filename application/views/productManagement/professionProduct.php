...
$professionobj = $profession[0];
?> 

<div class="col-md-12">
    <h2>
        <small>Profession:-</small>  <?php echo $professionobj['title'];?>
    </h2>
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                <a href="<?php echo base_url(); ?>index.php/ProductHandler/profession" class="btn btn-xs  btn-success" ><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-list"></i>&nbsp;&nbsp; Selected Product Report for <?php echo $professionobj['title'];?></h4>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered nowrap" id="data-table">
                        ...
                        <tbody>
                            ...
                            $count = 1;
                            if ($checkedProduct) {
                                foreach ($checkedProduct as $key => $value) {
                                    echo '<tr>';
...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-th-list"></i>&nbsp;&nbsp; You Can Choose Product From Here</h4>
        </div>
        <div class="panel-body">
            <form method="post">
                <div class="table-responsive" id="featureProduct">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $count = 1;
                            if ($uncheckedProduct) { 
                                foreach ($uncheckedProduct as $key => $value) {
                                    echo '<tr>';
