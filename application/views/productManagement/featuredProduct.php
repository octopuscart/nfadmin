...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-list"></i>&nbsp;&nbsp; Selected Feature Product Report</h4>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered nowrap" id="data-table">
                        ...
                        <tbody>
                            <?php
                            $count = 1;
                            if ($check_feature_product) {
                                foreach ($check_feature_product as $key => $value) {
                                    echo '<tr>';
...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-th-list"></i>&nbsp;&nbsp; Product Report, You Can Choose Feature Product From Here</h4>
        </div>
        <div class="panel-body">
            <form method="post">
