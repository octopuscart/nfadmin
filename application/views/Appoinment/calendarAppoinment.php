...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets_main/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu media-list pull-right animated fadeInDown">
                                ...
                                <li class="media">
                                    <a href="javascript:;">
                                        <div class="media-left"><img src="<?php echo base_url(); ?>assets_main/img/user-1.jpg" class="media-object" alt="" /></div>
                                        <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="javascript:;">
                                        <div class="media-left"><img src="<?php echo base_url(); ?>assets_main/img/user-2.jpg" class="media-object" alt="" /></div>
                                        <div class="media-body">
        ...
        <!-- ================== BEGIN PAGE LEVEL JS ================== -->
        <script src="<?php echo base_url(); ?>assets_main/plugins/fullcalendar/fullcalendar/fullcalendar.js"></script>
        <script src="<?php echo base_url(); ?>assets_main/js/calendar.demo.min.js"></script>
