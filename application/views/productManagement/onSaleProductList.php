...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-list"></i>&nbsp;&nbsp; Selected On Sale Product Report</h4>
        </div>
...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-th-list"></i>&nbsp;&nbsp; Product Report, You Can Choose On Sale Product From Here</h4>
        </div>
        <div class="panel-body">
            <form method="post">
                <div class="table-responsive" id="featureProduct">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $count = 1;
                            if ($onsale_product) { 
                                foreach ($onsale_product as $key => $value) {
                                    echo '<tr>';
