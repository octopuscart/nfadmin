...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-list"></i>&nbsp;&nbsp; Selected Most Popular Product Report</h4>
        </div>
...
<div class="col-md-12">
    <div class="panel panel-inverse" data-sortable-id="index-5">
        <div class="panel-heading">
            ...
            <h4 class="panel-title" style="font-size: 17px;font-weight: 500;"><i class="fa fa-th-list"></i>&nbsp;&nbsp; Product Report, You Can Choose Popular Product From Here</h4>
        </div>
        <div class="panel-body">
            <form method="post">
                        ...
                        <tbody>
                            ...
                            if ($most_popular_product) { 
                                foreach ($most_popular_product as $key => $value) {
                                    ...
                                    echo '<td>' . $value['title'] . '</td>';
                                    echo '<td>' . $value['sku'] . '</td>';
                                    echo '<td><img src="http://nf1.costcokart.com/nfw/small/' . $value['image'] . '" style="height:45px;width:60px;"/></td>';
                                    echo '<td>' . $value['product_speciality'] . '</td>';
