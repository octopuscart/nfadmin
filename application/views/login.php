...
<html lang="en">
    ...
    <head>
        ...
        <!-- ================== END BASE CSS STYLE ================== -->
        <link href="<?php echo base_url(); ?>assets_main/plugins/sweetalert/sweetalert.css" rel="stylesheet" id="theme" />
        <!-- ================== BEGIN BASE JS ================== -->
    ...
    <body class="pace-top">
        ...
        <div class="login-cover">
            <div class="login-cover-image"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-1.jpg" data-id="login-cover-image" alt="" /></div>
        ...
        <div id="page-container" class="fade">
            ...
            <div class="login login-v2" data-pageload-addclass="animated fadeIn">
                ...
                <div class="login-header">
                    <div class="brand"> 
                        <span class="logo"></span> Nita Fashions Admin  
                        <small></small>
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form method="post" class="margin-bottom-0">
                        ...
                        <div class="login-buttons">
                            <button type="submit" name="signIn" class="btn btn-success btn-block btn-lg">Sign me in</button>
                        </div>
                       <!-- <div class="m-t-20">
            ...
            <ul class="login-bg-list">
                <li class="active"><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-1.jpg" alt="" /></a></li>
                <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-2.jpg" alt="" /></a></li>
                <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-3.jpg" alt="" /></a></li>
                <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-4.jpg" alt="" /></a></li>
                <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-5.jpg" alt="" /></a></li>
                <li><a href="#" data-click="change-bg"><img src="<?php echo base_url(); ?>assets_main/img/login-bg/bg-6.jpg" alt="" /></a></li>
            </ul>
        ...
        <!-- ================== BEGIN PAGE LEVEL JS ================== -->
        <script src="<?php echo base_url(); ?>assets_main/js/login-v2.demo.min.js"></script>
...
//                if(msg){ 
//                   var id = swal("Here's a message!", "It's pretty, isn't it?");
//                   window.location.href = 'http://192.168.3.47/nf3/nitaFashionAdmin/index.php/';
//                }
            });
        </script>
    </body>
