...
<div class="panel panel-inverse" data-sortable-id="index-5">
    <div class="panel-heading">
        <h4 class="panel-title" style ="font-size:17px; font-weight:500; ">
            <i class="fa fa-edit"></i> Set Time Schedule</h4><br>
            <span>Start Date :<b><?php echo current($all_dates); ?></b></span>                                                 
            <span>End Date :<b><?php echo end($all_dates); ?></b></span>
            ...
            <table id="location_table" class="table table-striped table-bordered" style="">
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < count($all_dates); $i++) {
                        ...
                        <td>
                        <button s_date="<?php echo $data; ?>" class="btn btn-primary btn-xs make_appointment"  data-toggle = "modal" data-target = "#myModal" style="font-weight: bolder;" last_time="12:00am">
                            <i class='fa fa-plus'></i> Set Time
                        </button>
                        </td>
                        <td>
                         <?php
                         if(!empty($date_date)){
                             for($k=0;$k<count($date_date);$k++){
                              ...
                              if($vals['schedule_date'] === $data){
                                  ?>
                        <button class="btn btn-success btn-xs"  style="font-weight: bolder;"><?php echo strtoupper($vals['schedule_start_time']).'-'. strtoupper($vals['schedule_end_time'])?></button>
                     <?php         }
                         } }
                          ?>
                        </td>
            ...
            <form method="post">
                <div class = "modal-header">
                    ...
                    <h4 class = "modal-title" id = "myModalLabel">
                        <i class='fa fa-clock'></i> Set Time Interval
                    </h4>
                </div>
                ...
                <div class = "modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label">Time Schedule</label><br>
                ...
                <div class = "modal-footer">
                    ...
                    <button type = "submit" class = "btn btn-primary" name="submitPOP">
                        Submit changes
                    </button>
                </div>
            </form>
...
<script>
    $(document).ready(function () {
        <?php if(!empty($date_date)){ for($k=0;$k<count($date_date);$k++){
                              $vals = $date_date[$k]; 
                              $temp = $vals['schedule_end_time'];
         ?> 
                  // $(".make_appointment").attr('last_time').html('02:00am');
        <?php } }
                              ?>
        ...
        var datepair1 = new Datepair(basicExampleEl1);
